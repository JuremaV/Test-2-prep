...
document.onkeydown = function (event) {
    switch (event.key) {
        ...
        case "l": // translate left along the x-axis
            out4 += 0.01;
            break;
        case "g":  // translate right along the x-axis
            out4 -= 0.01;
            break;
        case "u":   //translate up along the y-axis
            out5 += 0.01;
            break;
        case "d": //translate down along the y-axis
            out5 -= 0.01;
            break;
       /* case "z":   //translate up along the z-axis
            out6 += 0.01;
            break;
        case "x": //translate down along the z-axis
            out6 -= 0.01;
            break;*/
